<template>
  <div class="border-b border-gray-100 last:border-b-0">
    <div class="p-4 flex items-center">
      ...
      <div class="flex-1 min-w-0">
        <div class="block text-sm font-medium">
          {{ alimento.nome }}
          <span class="text-gray-400">({{ alimento.mese_introduzione }}+)</span>
          <span
            v-if="alimento.allergeni"
        ...
        >
          ...
          <span class="text-xs font-medium">Reazione allergica</span>
        </div>
      </div>
    ...
    <div
      v-if="alimento.nota_personale || alimento.descrizione"
      class="px-4 pb-4 -mt-1"
    >
      <div
        v-if="alimento.descrizione"
        class="text-sm bg-blue-50 rounded-md p-3 mb-2 text-gray-600 border-l-2 border-blue-300"
      >
        {{ alimento.descrizione }}
      </div>
      <div
        v-if="alimento.nota_personale"
        class="text-sm bg-gray-50 rounded-md p-3 text-gray-600 border-l-2 border-yellow-500"
      >
    ...
    <div v-if="isExpanded" class="px-4 pb-4 space-y-3">
      <!-- Note nutrizionali -->
      <div
        v-if="alimento.note_nutrizionali"
        class="text-sm bg-green-50 rounded-md p-3 text-gray-600 border-l-2 border-green-300"
      >
        <div class="font-medium text-xs mb-1 text-gray-500">
          Note nutrizionali:
        </div>
      ...
      <div
        v-if="alimento.suggerimenti_preparazione"
        class="text-sm bg-amber-50 rounded-md p-3 text-gray-600 border-l-2 border-amber-300"
      >
        <div class="font-medium text-xs mb-1 text-gray-500">
      ...
      <div
        v-if="alimento.note"
        class="text-sm bg-purple-50 rounded-md p-3 text-gray-600 border-l-2 border-purple-300"
      >
