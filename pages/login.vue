      ...
      <div class="bg-white p-8 rounded-lg shadow-md">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div class="text-right">
            <button type="button" @click="navigateToForgotPassword" class="text-sm text-primary hover:text-indigo-800">
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            Non hai un account?
            <button @click="navigateToRegister" class="text-primary hover:text-indigo-800 font-medium">
              Registrati
            </button>
          </p>
        </div>
