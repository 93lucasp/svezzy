<template>
  <div class="flex flex-col min-h-screen bg-gray-50 relative">
    <div
      ...
      class="bg-gray-50 w-full sticky top-0 z-50"
      :style="`height: ${safeAreaStyles['--safe-area-inset-top']};`"
    />
    <!-- Contenuto principale -->
    <ion-content class="flex-1 custom-background">
      <slot />
      <nav
        v-if="shouldShowNavigation"
        class="bg-white border-t border-gray-200 fixed bottom-0 w-full pb-6 z-40"
      >
