<template>
  <div class="flex flex-col min-h-screen bg-gray-50">
    ...
    <nav v-if="shouldShowNavigation" class="bg-white border-t border-gray-200 fixed bottom-0 w-full">
...
const shouldShowNavigation = computed(() => {
  const authPages = ['index', 'registrazione', 'recupero-password', 'onboarding'];
